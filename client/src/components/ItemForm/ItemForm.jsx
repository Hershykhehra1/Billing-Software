            ...
            <div className="card-body">
              <form onSubmit={onSubmitHandler}>
                ...
                <div className="mb-3">
                  ...
                  <input type="number" name="price" id="price" className="form-control" placeholder="Item Price" step="0.01" onChange={onChangeHandler} value={data.price} />
                </div>

                {/* description */}
                <div className="mb-3">
                  <label htmlFor="description" className="form-label">Description</label>
                  <textarea rows="5" name="description" id="description" className="form-control" placeholder="Write description here..." onChange={onChangeHandler} value={data.description}></textarea>
                </div>
